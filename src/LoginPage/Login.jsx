          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-[16px] font-medium rounded-lg text-white bg-gradient-to-r from-base to-primary    focus:outline-none  disabled:opacity-50 cursor-pointer transition duration-200 "
              >
                {loading ? (
                  <div className="flex items-center">
                    <svg
