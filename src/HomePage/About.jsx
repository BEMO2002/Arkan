      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2 text-center md:text-start ">
            <h2 className="text-xl lg:text-[32px] font-[700] text-base mb-1 leading-[44px]">
              {t("AboutTitle")} <br />
              <span className="text-base">{t("AboutTitleTwo")}</span>
            </h2>
            <p className="md:text-[24px] text-[19px] text-base font-[400] mt-[16px] lg:w-[600px] h-[108px] w-[350px] mx-auto md:mx-0">
              {t("AboutDescription")}
            </p>
            <p className="md:text-[20px] text-[15px] text-baseTwo font-[400] leading-[30px] mt-[8px] lg:w-[600px] h-[108px]  w-[350px] mx-auto md:mx-0">
